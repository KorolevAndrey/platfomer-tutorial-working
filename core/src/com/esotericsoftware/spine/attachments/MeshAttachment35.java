...
//
//    public MeshAttachment35 (String name) {
//        super(name);
//    }
//
...
//        float[] vertices = this.getWorldVertices(), worldVertices = this.worldVertices;
//        //int[] bones = null;
...
//        if (parentMesh != null) {
//            setBones(parentMesh.getBones());
//            setVertices(parentMesh.getVertices());
//            regionUVs = parentMesh.getRegionUVs();
//            triangles = parentMesh.getTriangles();
//            hullLength = parentMesh.getHullLength();
//            edges = parentMesh.getEdges();
//            width = parentMesh.getWidth();
//            height = parentMesh.getHeight();
//        }
//    }
//
